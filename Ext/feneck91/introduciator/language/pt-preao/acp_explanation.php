...
$lang = array_merge($lang, [
	...
	'INTRODUCIATOR_EP_DISPLAY_PAGE_EXPLAIN'					=> 'Esta opção é usada para exibir a página de explicação quando um utilizador tenta criar uma mensagem ou um tópico num fórum que não o das apresentações.',
	...
	'INTRODUCIATOR_EP_GENERAL_OPTIONS_TEXTS_TITLE_EXPLAIN'	=> 'Para todos os campos que se seguem, podes usar:<br/>
																					...
																					<li><b>%forum_post%</b>: url directo para criação de tópico no fórum para apresentações</li>
																					</ul>
