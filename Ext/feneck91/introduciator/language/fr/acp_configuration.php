...
/**
 * Mode : configuration
 * Info : Les clefs de langues sont préfixées avec 'INTRODUCIATOR_CP_' pour 'INTRODUCIATOR_CONFIGURATION_PAGES_'
 */
$lang = array_merge($lang, array(
	...
	'INTRODUCIATOR_CP_MANDATORY_INTRODUCE_EXPLAIN'					=> 'Quand cette option est activée, l’extension force l’utilisateur à poster sa propre présentation avant d’être autorisé à poster dans les autres sujets.
																			<br />Lorsque cette fonctionnalité n’est pas activée, toutes les autres options restent actives.',
	'INTRODUCIATOR_CP_CHECK_DEL_1ST_POST'							=> 'Interdire la suppression du premier message d’un sujet de présentation :',
	'INTRODUCIATOR_CP_CHECK_DEL_1ST_POST_EXPLAIN'					=> 'Lorsque cette option est activée, l’extension empêche la suppression du premier message qui a créé le sujet dans le forum de présentation.
	...
	'INTRODUCIATOR_CP_POSTING_APPROVAL_LEVEL_EXPLAIN'				=> 'Est utilisé pour forcer l’approbation de la présentation par un modérateur :<br />
																			...
																			<li><b>Approbation avec édition</b> : force l’approbation de la présentation. L’utilisateur voit sa présentation immédiatement et peut la modifier. Il ne peut pas poster ailleurs tant qu’elle n’est pas validée par un modérateur. Ceci permet aux modérateurs et à l’utilisateur d’échanger afin que ce dernier puisse mettre son message en conformité avant validation par le modérateur (traitement différent des messages nécessitant une approbation). Seule la modification est autorisée, répondre ou citer ne l’est pas.</li>
																			</ul>',
	...
	'INTRODUCIATOR_CP_INCLUDE_EXCLUDE_GROUPS_EXPLAIN'				=> 'Lorsque les groupes inclus sont sélectionnés, seuls les utilisateurs des groupes sélectionnés doivent se présenter.<br />Lorsque les groupes exclus sont sélectionnés, seuls les utilisateurs ne faisant pas partie des groupes sélectionnés doivent se présenter.',
