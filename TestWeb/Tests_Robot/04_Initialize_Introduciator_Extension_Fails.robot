...
# Configure extension: should failed
Configure Extension Failed
    ...
    ${result} =         FM.Introduciator Extension Configure  ${TRUE}  ${FALSE}  ${FALSE}  ${EMPTY}  ${INTRODUCIATOR_APPROVAL_LEVEL_NO}  ${TRUE}  ${None}  ${None}  ${EMPTY}
    Should Be Equal     ${result}  ${FALSE}

# Configure extension: should succeeded
Configure Extension Succeeded
    ...
    ${result} =         FM.Introduciator Extension Configure  ${TRUE}  ${FALSE}  ${FALSE}  ${INTRODUCIATOR_FORUM_NAME}  ${INTRODUCIATOR_APPROVAL_LEVEL_NO}  ${TRUE}  ${None}  ${None}  ${EMPTY}
    Should Be True      ${result}
